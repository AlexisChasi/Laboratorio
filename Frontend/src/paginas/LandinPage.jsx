...
export const LandinPage = () => {
    ...
    return (
        <div className={darkMode ? "dark" : ""}>
                ...
                <section>
                    <nav className='p-10 mb-12 flex justify-between'>
                        ...
                        <ul className='flex items-center'>
                            ...
                            <li><Link to="/login" className='bg-[#F4E869] text-grey-400 px-6 py-2 rounded-full ml-8 hover:bg-gray-900 hover:text-white' href="#">Iniciar sesión</Link>
                            </li>
                        </ul>
                    </nav>
                ...
                <section>
                    ...
                    >
                        ...
                        <div className='flex justify-center items-center'> {/* Agregamos flex y justify-center para centrar horizontalmente */}
                            <div className='text-center shadow-2xl p-10 rounded-xl my-10 md:w-72 lg:w-96 bg-[#E2C799]'>
                                <div className='mx-auto w-72 h-40 overflow-hidden rounded-lg'>
                                    <img className='w-full h-full object-cover' src={vet} alt="" />
                                </div>
            ...
            <footer className='bg-[#ADC4CE] text-grey py-8'>
